  ...
  return (
    <section className={styles.result}>
      <main>
        ...
        <div />
        <h3>Что дальше?</h3>
        <p>Пока у нас не достаточно анкет, чтобы запустить сервис. Ведь вы не хотите видеть 5 анкет. Сейчас мы активно работаем, чтобы увеличить количество людей, которые хотят настоящих отношений.</p>
